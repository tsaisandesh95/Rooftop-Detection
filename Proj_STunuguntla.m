%Project
%Sai Sandesh Tunuguntla -11141205
...
figure(1);imshow(original_image);title('given original RGB image');

%Converted to Gray Image using rgb2gray function
gray_image=rgb2gray(original_image);
figure(2); imshow(gray_image);title('converted to gray from RGB image');
...
figure;
imshow(bw);title('final logical expression');
